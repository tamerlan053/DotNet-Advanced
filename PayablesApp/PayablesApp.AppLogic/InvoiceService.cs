...
internal class InvoiceService : IInvoiceService
{
    ...
    public decimal GetInvoicesTotal()
    {
        ...
        var query = from invoice in AllInvoices // in de klass
                    select invoice.InvoiceTotal;

        return query.Sum();

        return AllInvoices.Sum(invoice => invoice.InvoiceTotal);
    }
