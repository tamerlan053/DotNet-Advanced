...
public class MockPieRepository : IPieRepository
{
    ...
    private readonly IEnumerable<Pie> _allPies;
    ...
    public Task<IEnumerable<Pie>> GetAllPies()
    {
        return Task.FromResult(_allPies);
    }

    public IEnumerable<Pie> GetPiesOfTheWeek()
    {
        return _allPies.Where(p => p.IsPieOfTheWeek);
    }

    public Pie GetById(int id)
    {
        return _allPies.First(p => p.PieId == id);
    }
